    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商品地点" prop="shangpinAddress">
                       <el-input v-model="ruleForm.shangpinAddress"
                                 placeholder="商品地点" clearable  :readonly="ro.shangpinAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="商品地点" prop="shangpinAddress">
                           <el-input v-model="ruleForm.shangpinAddress"
                                     placeholder="商品地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinAddress: [
                              { required: true, message: '商品地点不能为空', trigger: 'blur' },
                          ],
                   zanNumber: [
